  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/other/gravatar.jpg')
      } else {
        ele.src = 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/other/default_avatar.jpg'
      }
      break
    case 2:
      ele.src = 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/other/default_gavatar.jpg'
      break
    case 3:

      ele.src = 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/other/image-404.png'
      break
    default:
      ele.src = 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/other/image-404.png'
  }
    ...
    for (var i = 0; i < this.files.length; i++) {
      ...
      $.ajax({
        ...
        beforeSend: function (xhr) {
          ...
          $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="https://jsd.onmicrosoft.cn/gh/moezx/cdn@3.0.2/img/svg/loader/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />')
          lazyload()
...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/themebg/sakura.png' || bgurl == 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/themebg/plaid.jpg' || bgurl == 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/themebg/star.png' || bgurl == 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/themebg/point.png' || bgurl == 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/themebg/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/themebg/sakura.png')
  changeBG('#gribs-bg', 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/themebg/plaid.jpg')
  changeBG('#pixiv-bg', 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/themebg/star.png')
  changeBG('#KAdots-bg', 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/themebg/point.png')
  changeBG('#totem-bg', 'https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/themebg/little-monster.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://jsd.onmicrosoft.cn/gh/honjun/cdn@1.6/img/other/starry_sky.png)')
...
//             bot_ui_ini();
//         } else {
//             $.getScript('https://jsd.onmicrosoft.cn/gh/moezx/cdn@latest/js/botui/botui.js', function () {
//                 bot_ui_ini();
...
//         loadCSS("https://jsd.onmicrosoft.cn/gh/moezx/cdn@3.1.8/css/cn.css");
//         currentFontIsUbuntu = false;
//     } else {
//         loadCSS("https://jsd.onmicrosoft.cn/gh/moezx/cdn@3.1.8/css/or.css");
...
//         loadCSS("https://jsd.onmicrosoft.cn/gh/moezx/cdn@3.1.8/css/tw.css");
//     }
//     if (zh == 'tw') {
...
// loadCSS("https://jsd.onmicrosoft.cn/gh/moezx/cdn@3.5.4/fonts/Moe-Mashiro/stylesheet.css");
// loadCSS("https://fonts.googleapis.com/css?family=Noto+SerifMerriweather|Merriweather+Sans|Source+Code+Pro|Ubuntu:400,700");
// loadCSS("https://jsd.onmicrosoft.cn/gh/moezx/cdn@3.3.9/css/sharejs.css");;
